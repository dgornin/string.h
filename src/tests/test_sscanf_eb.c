...
Suite* s21_sscanf_eb_suite(void) {
  ...
  s = suite_create("s21_sscanf_eb");
  tc_core = tcase_create("Core");

  tcase_add_test(tc_core, floats1);
  tcase_add_test(tc_core, floats2);
  tcase_add_test(tc_core, floats3);
  tcase_add_test(tc_core, point_only);
  tcase_add_test(tc_core, simple_E1);
  tcase_add_test(tc_core, simple_E2);
  tcase_add_test(tc_core, simple_E3);
  tcase_add_test(tc_core, simple_E4);
  tcase_add_test(tc_core, simple_E5);
  tcase_add_test(tc_core, simple_E6);
