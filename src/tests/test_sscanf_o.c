...
START_TEST(octal_simple_test) {
  const char str[] = "521561612 +2";
  const char fstr[] = "%*o %1o";
  unsigned a1 = 0, a2 = 0;
  uint32_t res1 = s21_sscanf(str, fstr, &a1);
  uint32_t res2 = sscanf(str, fstr, &a2);
...
START_TEST(octal_simple_test2) {
  const char str[] = "521561612 +8 -32";
  const char fstr[] = "%*o %1o %5o";
  unsigned a1 = 0, a2 = 0, b1 = 0, b2 = 0;
...
Suite* s21_sscanf_o_suite(void) {
  ...
  tcase_add_test(tc_core, octal_simple_test);
  tcase_add_test(tc_core, octal_simple_test2);
  tcase_add_test(tc_core, octal_simple_test3);
